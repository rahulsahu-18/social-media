...
const Post = ({ post }) => {
    ...
    const likeOrDislikeHandler = async () => {
        try {
            ...
            const res = await axios.get(`https://instaclone-g9h5.onrender.com/api/v1/post/${action}/${post._id}`, { withCredentials: true });
    ...
    const commentHandler = async () => {
        ...
        try {
            const res = await axios.post(`http://localhost:3000/api/v1/post/add-comment/${post._id}`, { text }, {
                headers: {
    ...
    const bookmarkHandler = async () => {
        try {
            const res = await axios.get(`http://localhost:3000/api/v1/post/bookmark/${post?._id}`, {withCredentials:true});
            if(res.data.success){
                toast.success(res.data.message);
            }
        } catch (error) {
